  ...
  return (
    <div className="w-[40%] flex flex-col overflow-y-auto">
      <div className="p-6 space-y-6">
        ...
        <div>
          ...
          {patternWarning && (
            <motion.div
              ...
              className="mb-4 p-4 rounded-lg border border-yellow-500/30 bg-yellow-500/5"
            >
        ...
        {/* Explanations */}
        {whyExplanation && (
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="glass-card glow-border-cyan p-5">
        ...
        {fixExplanation && (
          <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="glass-card glow-border-purple p-5">
